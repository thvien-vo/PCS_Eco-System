        ...
        {isOpen && item && (
          <>
            ...
            <motion.div
              ...
              className={cn(
                'fixed inset-x-0 bottom-0 z-[160] mx-auto w-full max-w-[374px]',
            ...
            >
              ...
              <button
                ...
                onClick={onClose}
                className="bg-border/50 absolute right-4 top-4 flex h-8 w-8 items-center justify-center rounded-full text-muted-foreground transition-colors hover:bg-border"
              ...
              <div className="flex flex-col items-center gap-4 p-6 pt-3">
                ...
                <motion.div
                  ...
                  className="bg-emerald/10 flex h-16 w-16 items-center justify-center rounded-full"
                >
                ...
                {/* Redemption code */}
                <div className="border-emerald/30 bg-emerald/5 w-full rounded-2xl border-2 border-dashed p-4">
                ...
                <button
                  ...
                  onClick={onClose}
                  className="min-h-[44px] w-full rounded-full bg-gradient-to-r from-emerald to-mint py-3 text-sm font-bold text-white shadow-sm transition-opacity hover:opacity-90 active:scale-[0.98]"
                >
                  {labels.doneButton}
                </button>
              </div>
